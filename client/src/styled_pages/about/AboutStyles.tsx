...
import WorldGlobe from "../../componets/worldGlobe/WorldGlobe";
...
`;
const SytleWorldGlobe = styled.div`
  width: 60%;
  border-radius: 100%;

`;

export const WorldGlobeAboutPage = () => {
  return ( <SytleWorldGlobe><WorldGlobe backgroundImage={""}/></SytleWorldGlobe>) 
